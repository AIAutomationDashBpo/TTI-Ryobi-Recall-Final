...
export default function Home() {
  ...
  /* =========================================================
     ✅ PREFILL FROM URL (RUNS ONCE, SAFE ON VERCEL)
     ========================================================= */
  useEffect(() => {
    if (initialized.current) return;

    // ---- PHONE (handles +, %2B, spaces, tel alias)
    const rawPhone =
    ...
    // ---- MODEL (supports model OR modelNumber)
    const modelNumber =
      searchParams.get("modelNumber") ||
      searchParams.get("model") ||
      "RY-4567";

    // ---- SERIAL (supports serial OR serialNumber)
    const serialNumber =
  ...
  /* =========================================================
     SUBMIT HANDLER (ROBUST FOR VERCEL + N8N)
     ========================================================= */
    ...
    <>
      ...
      <footer className="footer">
        <div className="footer-content">
          ...
          <div className="social-icons">{/* unchanged */}</div>
        </div>
